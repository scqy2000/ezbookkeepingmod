...
import { TransactionAmountsRequest } from "@/models/transaction.ts";
import type {
...
import type {
    InstallmentAccountRuleSaveRequest,
    InstallmentAccountRuleDeleteRequest,
    InstallmentAccountRuleInfoResponse,
    InstallmentPlanRequest,
    InstallmentPlanModifyRequest,
    InstallmentPlanDeleteRequest,
    InstallmentItemPayRequest,
    InstallmentItemUnpayRequest,
    InstallmentPlanInfoResponse,
...
import type { OAuth2CallbackLoginRequest } from "@/models/oauth2.ts";
import type { UserApplicationCloudSettingsUpdateRequest } from "@/models/user_app_cloud_setting.ts";
import type { RecognizedReceiptImageResponse } from "@/models/large_language_model.ts";

import { getCurrentToken, clearCurrentTokenAndUserInfo } from "./userstate.ts";
...
import { getTimeZone } from "./settings.ts";
import {
    getGoogleMapAPIKey,
    getBaiduMapAK,
...
axios.interceptors.request.use(
    (config: ApiRequestConfig) => {
        ...
        config.headers["X-Timezone-Offset"] =
            getTimezoneOffsetMinutes(getCurrentUnixTime());
...
axios.interceptors.response.use(
    (response) => {
        if (
            "cancelableUuid" in response.config &&
            response.config.cancelableUuid &&
            cancelableRequests[response.config.cancelableUuid as string]
        ) {
            logger.debug(
                "Response canceled by user request, url: " +
                    response.config.url +
                    ", cancelableUuid: " +
                    response.config.cancelableUuid,
            );
    ...
    (error) => {
        if (
            "cancelableUuid" in error.response.config &&
...
export default {
    ...
    authorize2FA: ({
        ...
        passcode: string;
        token: string;
    }): ApiResponsePromise<AuthResponse> => {
    ...
    ): ApiResponsePromise<RegisterResponse> => {
    ...
    }): ApiResponsePromise<UserVerifyEmailResponse> => {
        return axios.post<ApiResponse<UserVerifyEmailResponse>>(
    ...
    resendVerifyEmailByUnloginUser: (
        req: UserResendVerifyEmailRequest,
    ...
    getExternalAuths: (): ApiResponsePromise<
        UserExternalAuthInfoResponse[]
    > => {
        return axios.get<ApiResponse<UserExternalAuthInfoResponse[]>>(
            "v1/users/external_auth/list.json",
        );
    },
    unlinkExternalAuth: (
        req: UserExternalAuthUnlinkRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/users/external_auth/unlink.json",
            req,
        );
    },
    getTokens: (): ApiResponsePromise<TokenInfoResponse[]> => {
        return axios.get<ApiResponse<TokenInfoResponse[]>>(
            "v1/tokens/list.json",
        );
    },
    generateAPIToken: (
        req: TokenGenerateAPIRequest,
    ): ApiResponsePromise<TokenGenerateAPIResponse> => {
        return axios.post<ApiResponse<TokenGenerateAPIResponse>>(
            "v1/tokens/generate/api.json",
            req,
        );
    },
    generateMCPToken: (
        req: TokenGenerateMCPRequest,
    ): ApiResponsePromise<TokenGenerateMCPResponse> => {
        return axios.post<ApiResponse<TokenGenerateMCPResponse>>(
            "v1/tokens/generate/mcp.json",
            req,
        );
    },
    revokeToken: ({
    ...
    getProfile: (): ApiResponsePromise<UserProfileResponse> => {
        return axios.get<ApiResponse<UserProfileResponse>>(
            "v1/users/profile/get.json",
        );
    },
    updateProfile: (
        req: UserProfileUpdateRequest,
    ): ApiResponsePromise<UserProfileUpdateResponse> => {
        return axios.post<ApiResponse<UserProfileUpdateResponse>>(
            "v1/users/profile/update.json",
            req,
        );
    },
    updateAvatar: ({
        ...
        avatarFile: File;
    }): ApiResponsePromise<UserProfileResponse> => {
        return axios.postForm<ApiResponse<UserProfileResponse>>(
    ...
    removeAvatar: (): ApiResponsePromise<UserProfileResponse> => {
        return axios.post<ApiResponse<UserProfileResponse>>(
            "v1/users/avatar/remove.json",
        );
    },
    resendVerifyEmailByLoginedUser: (): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/users/verify_email/resend.json",
        );
    },
    getUserApplicationCloudSettings: (): ApiResponsePromise<
        ApplicationCloudSetting[] | false
    > => {
        return axios.get<ApiResponse<ApplicationCloudSetting[] | false>>(
            "v1/users/settings/cloud/get.json",
        );
    },
    updateUserApplicationCloudSettings: (
        req: UserApplicationCloudSettingsUpdateRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/users/settings/cloud/update.json",
            req,
        );
    },
    disableUserApplicationCloudSettings: (): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/users/settings/cloud/disable.json",
        );
    },
    get2FAStatus: (): ApiResponsePromise<TwoFactorStatusResponse> => {
        return axios.get<ApiResponse<TwoFactorStatusResponse>>(
            "v1/users/2fa/status.json",
        );
    },
    enable2FA: (): ApiResponsePromise<TwoFactorEnableResponse> => {
        return axios.post<ApiResponse<TwoFactorEnableResponse>>(
            "v1/users/2fa/enable/request.json",
        );
    },
    confirmEnable2FA: (
        req: TwoFactorEnableConfirmRequest,
    ): ApiResponsePromise<TwoFactorEnableConfirmResponse> => {
        return axios.post<ApiResponse<TwoFactorEnableConfirmResponse>>(
            "v1/users/2fa/enable/confirm.json",
            req,
        );
    },
    ...
    regenerate2FARecoveryCode: (
        req: TwoFactorRegenerateRecoveryCodeRequest,
    ): ApiResponsePromise<TwoFactorEnableConfirmResponse> => {
        return axios.post<ApiResponse<TwoFactorEnableConfirmResponse>>(
    ...
    getUserDataStatistics: (): ApiResponsePromise<DataStatisticsResponse> => {
        return axios.get<ApiResponse<DataStatisticsResponse>>(
            "v1/data/statistics.json",
        );
    },
    getExportedUserData: (
        fileType: string,
        req?: ExportTransactionDataRequest,
        ...
        if (req) {
            ...
            params =
                "max_time=0&min_time=0&type=0&category_ids=&account_ids=&tag_filter=&amount_filter=&keyword=";
        }
    ...
    clearAllTransactions: (
        ...
        return axios.post<ApiResponse<boolean>>(
            "v1/data/clear/transactions.json",
            req,
            {
                timeout: DEFAULT_CLEAR_ALL_TRANSACTIONS_API_TIMEOUT,
            } as ApiRequestConfig,
    ...
    clearAllTransactionsOfAccount: (
        req: ClearAccountTransactionsRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
    ...
    getAllAccounts: ({
        ...
        visibleOnly: boolean;
    }): ApiResponsePromise<AccountInfoResponse[]> => {
        return axios.get<ApiResponse<AccountInfoResponse[]>>(
            "v1/accounts/list.json?visible_only=" + visibleOnly,
        );
    },
    getAccount: ({
        id,
        ...
        return axios.get<ApiResponse<AccountInfoResponse>>(
            "v1/accounts/get.json?id=" + id,
        );
    },
    addAccount: (
        req: AccountCreateRequest,
    ): ApiResponsePromise<AccountInfoResponse> => {
        return axios.post<ApiResponse<AccountInfoResponse>>(
            "v1/accounts/add.json",
            req,
        );
    },
    modifyAccount: (
        req: AccountModifyRequest,
    ): ApiResponsePromise<AccountInfoResponse> => {
        return axios.post<ApiResponse<AccountInfoResponse>>(
            "v1/accounts/modify.json",
            req,
        );
    },
    ...
    getTransactions: (
        req: TransactionListByMaxTimeRequest,
    ): ApiResponsePromise<TransactionInfoPageWrapperResponse> => {
        const tagFilter = encodeURIComponent(req.tagFilter);
        const amountFilter = encodeURIComponent(req.amountFilter);
        const keyword = encodeURIComponent(req.keyword);
        return axios.get<ApiResponse<TransactionInfoPageWrapperResponse>>(
            `v1/transactions/list.json?max_time=${req.maxTime}&min_time=${req.minTime}&type=${req.type}&category_ids=${req.categoryIds}&account_ids=${req.accountIds}&tag_filter=${tagFilter}&amount_filter=${amountFilter}&keyword=${keyword}&count=${req.count}&page=${req.page}&with_count=${req.withCount}&trim_account=true&trim_category=true&trim_tag=true`,
        );
    },
    getAllTransactionsByMonth: (
        req: TransactionListInMonthByPageRequest,
    ): ApiResponsePromise<TransactionInfoPageWrapperResponse2> => {
        const tagFilter = encodeURIComponent(req.tagFilter);
        const amountFilter = encodeURIComponent(req.amountFilter);
        const keyword = encodeURIComponent(req.keyword);
        return axios.get<ApiResponse<TransactionInfoPageWrapperResponse2>>(
            `v1/transactions/list/by_month.json?year=${req.year}&month=${req.month}&type=${req.type}&category_ids=${req.categoryIds}&account_ids=${req.accountIds}&tag_filter=${tagFilter}&amount_filter=${amountFilter}&keyword=${keyword}&trim_account=true&trim_category=true&trim_tag=true`,
        );
    },
    getAllTransactions: (
        req: TransactionAllListRequest,
    ): ApiResponsePromise<TransactionInfoResponse[]> => {
        return axios.get<ApiResponse<TransactionInfoResponse[]>>(
            `v1/transactions/list/all.json?trim_account=true&with_pictures=${!!req.withPictures}&trim_category=true&trim_tag=true&start_time=${req.startTime}&end_time=${req.endTime}`,
        );
    },
    getReconciliationStatements: (
        req: TransactionReconciliationStatementRequest,
    ): ApiResponsePromise<TransactionReconciliationStatementResponse> => {
        return axios.get<
            ApiResponse<TransactionReconciliationStatementResponse>
        >(
            `v1/transactions/reconciliation_statements.json?account_id=${req.accountId}&start_time=${req.startTime}&end_time=${req.endTime}`,
        );
    },
    getTransactionStatistics: (
        req: TransactionStatisticRequest,
    ): ApiResponsePromise<TransactionStatisticResponse> => {
        ...
        return axios.get<ApiResponse<TransactionStatisticResponse>>(
            `v1/transactions/statistics.json?use_transaction_timezone=${req.useTransactionTimezone}` +
                (queryParams.length ? "&" + queryParams.join("&") : ""),
        );
    },
    getTransactionStatisticsTrends: (
        req: TransactionStatisticTrendsRequest,
    ): ApiResponsePromise<TransactionStatisticTrendsResponseItem[]> => {
        const queryParams: string[] = [];
        ...
        return axios.get<ApiResponse<TransactionStatisticTrendsResponseItem[]>>(
            `v1/transactions/statistics/trends.json?use_transaction_timezone=${req.useTransactionTimezone}` +
                (queryParams.length ? "&" + queryParams.join("&") : ""),
        );
    },
    getTransactionStatisticsAssetTrends: (
        req: TransactionStatisticAssetTrendsRequest,
    ): ApiResponsePromise<TransactionStatisticAssetTrendsResponseItem[]> => {
        const queryParams: string[] = [];
        ...
        return axios.get<
            ApiResponse<TransactionStatisticAssetTrendsResponseItem[]>
        >(
            "v1/transactions/statistics/asset_trends.json" +
                (queryParams.length ? "?" + queryParams.join("&") : ""),
        );
    },
    getTransactionAmounts: (
        params: TransactionAmountsRequestParams,
        excludeAccountIds: string[],
        excludeCategoryIds: string[],
    ): ApiResponsePromise<TransactionAmountsResponse> => {
        ...
        if (excludeCategoryIds && excludeCategoryIds.length) {
            queryParams =
                queryParams +
                `&exclude_category_ids=${excludeCategoryIds.join(",")}`;
        }

        return axios.get<ApiResponse<TransactionAmountsResponse>>(
            `v1/transactions/amounts.json?${queryParams}`,
        );
    },
    getTransaction: ({
        id,
        ...
        id: string;
        withPictures: boolean | undefined;
    }): ApiResponsePromise<TransactionInfoResponse> => {
        ...
        return axios.get<ApiResponse<TransactionInfoResponse>>(
            `v1/transactions/get.json?id=${id}&with_pictures=${withPictures}&trim_account=true&trim_category=true&trim_tag=true`,
        );
    },
    addTransaction: (
        req: TransactionCreateRequest,
    ): ApiResponsePromise<TransactionInfoResponse> => {
        return axios.post<ApiResponse<TransactionInfoResponse>>(
    ...
    moveAllTransactionsBetweenAccounts: (
        req: TransactionMoveBetweenAccountsRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/transactions/move/all.json",
            req,
        );
    },
    deleteTransaction: (
    ...
    parseImportCustomFile: ({
        ...
        return axios.postForm<ApiResponse<string[][]>>(
            "v1/transactions/parse_custom_file.json",
            {
                fileType: fileType,
    ...
    parseImportTransaction: ({
        ...
        fileType: string;
        additionalOptions?: ImportFileTypeSupportedAdditionalOptions;
        fileEncoding?: string;
        importFile: File;
        ...
        geoOrder?: string;
        tagSeparator?: string;
    }): ApiResponsePromise<ImportTransactionResponsePageWrapper> => {
        ...
        if (additionalOptions) {
            textualAdditionalOptions = objectFieldWithValueToArrayItem(
                additionalOptions,
                true,
            ).join(",");
        }
        ...
        if (transactionTypeMapping) {
            textualTransactionTypeMapping = JSON.stringify(
                transactionTypeMapping,
            );
        }
        ...
        return axios.postForm<
            ApiResponse<ImportTransactionResponsePageWrapper>
        >(
            "v1/transactions/parse_import.json",
            {
                fileType: fileType,
    ...
    ): ApiResponsePromise<number> => {
        return axios.post<ApiResponse<number>>(
            "v1/transactions/import.json",
            req,
            {
    ...
    ): ApiResponsePromise<number | null> => {
        return axios.get<ApiResponse<number | null>>(
            "v1/transactions/import/process.json?client_session_id=" +
                clientSessionId,
            {
                ignoreError: true,
            } as ApiRequestConfig,
    ...
    uploadTransactionPicture: ({
        ...
        pictureFile: File;
        clientSessionId?: string;
    }): ApiResponsePromise<TransactionPictureInfoBasicResponse> => {
        return axios.postForm<ApiResponse<TransactionPictureInfoBasicResponse>>(
    ...
    removeUnusedTransactionPicture: (
        ...
        return axios.post<ApiResponse<boolean>>(
            "v1/transaction/pictures/remove_unused.json",
            req,
        );
    },
    getAllTransactionCategories: (): ApiResponsePromise<
        Record<number, TransactionCategoryInfoResponse[]>
    > => {
        return axios.get<
            ApiResponse<Record<number, TransactionCategoryInfoResponse[]>>
    ...
    getTransactionCategory: ({
        ...
        id: string;
    }): ApiResponsePromise<TransactionCategoryInfoResponse> => {
        return axios.get<ApiResponse<TransactionCategoryInfoResponse>>(
            "v1/transaction/categories/get.json?id=" + id,
        );
    },
    addTransactionCategory: (
        req: TransactionCategoryCreateRequest,
    ): ApiResponsePromise<TransactionCategoryInfoResponse> => {
        return axios.post<ApiResponse<TransactionCategoryInfoResponse>>(
            "v1/transaction/categories/add.json",
            req,
        );
    },
    addTransactionCategoryBatch: (
        req: TransactionCategoryCreateBatchRequest,
    ): ApiResponsePromise<
        Record<number, TransactionCategoryInfoResponse[]>
    > => {
        return axios.post<
            ApiResponse<Record<number, TransactionCategoryInfoResponse[]>>
        >("v1/transaction/categories/add_batch.json", req);
    },
    modifyTransactionCategory: (
        req: TransactionCategoryModifyRequest,
    ): ApiResponsePromise<TransactionCategoryInfoResponse> => {
        return axios.post<ApiResponse<TransactionCategoryInfoResponse>>(
            "v1/transaction/categories/modify.json",
            req,
        );
    },
    hideTransactionCategory: (
        req: TransactionCategoryHideRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/transaction/categories/hide.json",
            req,
        );
    },
    moveTransactionCategory: (
        req: TransactionCategoryMoveRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/transaction/categories/move.json",
            req,
        );
    },
    deleteTransactionCategory: (
        req: TransactionCategoryDeleteRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/transaction/categories/delete.json",
            req,
        );
    },
    getAllTransactionTagGroups: (): ApiResponsePromise<
        TransactionTagGroupInfoResponse[]
    > => {
        return axios.get<ApiResponse<TransactionTagInfoResponse[]>>(
            "v1/transaction/tags/groups/list.json",
        );
    },
    getTransactionTagGroup: ({
        id,
    }: {
        id: string;
    }): ApiResponsePromise<TransactionTagGroupInfoResponse> => {
        return axios.get<ApiResponse<TransactionTagInfoResponse>>(
            "v1/transaction/tags/groups/get.json?id=" + id,
        );
    },
    addTransactionTagGroup: (
        req: TransactionTagGroupCreateRequest,
    ): ApiResponsePromise<TransactionTagGroupInfoResponse> => {
        return axios.post<ApiResponse<TransactionTagInfoResponse>>(
            "v1/transaction/tags/groups/add.json",
            req,
        );
    },
    modifyTransactionTagGroup: (
        req: TransactionTagGroupModifyRequest,
    ): ApiResponsePromise<TransactionTagGroupInfoResponse> => {
        return axios.post<ApiResponse<TransactionTagInfoResponse>>(
            "v1/transaction/tags/groups/modify.json",
            req,
        );
    },
    moveTransactionTagGroup: (
        req: TransactionTagGroupMoveRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/transaction/tags/groups/move.json",
            req,
        );
    },
    deleteTransactionTagGroup: (
        req: TransactionTagGroupDeleteRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/transaction/tags/groups/delete.json",
            req,
        );
    },
    getAllTransactionTags: (): ApiResponsePromise<
        TransactionTagInfoResponse[]
    > => {
        return axios.get<ApiResponse<TransactionTagInfoResponse[]>>(
            "v1/transaction/tags/list.json",
        );
    },
    getTransactionTag: ({
        id,
        ...
        id: string;
    }): ApiResponsePromise<TransactionTagInfoResponse> => {
        return axios.get<ApiResponse<TransactionTagInfoResponse>>(
            "v1/transaction/tags/get.json?id=" + id,
        );
    },
    addTransactionTag: (
        req: TransactionTagCreateRequest,
    ): ApiResponsePromise<TransactionTagInfoResponse> => {
        return axios.post<ApiResponse<TransactionTagInfoResponse>>(
            "v1/transaction/tags/add.json",
            req,
        );
    },
    addTransactionTagBatch: (
        req: TransactionTagCreateBatchRequest,
    ): ApiResponsePromise<TransactionTagInfoResponse[]> => {
        return axios.post<ApiResponse<TransactionTagInfoResponse[]>>(
            "v1/transaction/tags/add_batch.json",
            req,
        );
    },
    modifyTransactionTag: (
        req: TransactionTagModifyRequest,
    ): ApiResponsePromise<TransactionTagInfoResponse> => {
        return axios.post<ApiResponse<TransactionTagInfoResponse>>(
    ...
    moveTransactionTag: (
        req: TransactionTagMoveRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/transaction/tags/move.json",
            req,
        );
    },
    deleteTransactionTag: (
        req: TransactionTagDeleteRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/transaction/tags/delete.json",
            req,
        );
    },
    getAllTransactionTemplates: ({
        ...
        templateType: number;
    }): ApiResponsePromise<TransactionTemplateInfoResponse[]> => {
        return axios.get<ApiResponse<TransactionTemplateInfoResponse[]>>(
            "v1/transaction/templates/list.json?templateType=" + templateType,
        );
    },
    getTransactionTemplate: ({
        ...
        return axios.get<ApiResponse<TransactionTemplateInfoResponse>>(
            "v1/transaction/templates/get.json?id=" + id,
        );
    },
    addTransactionTemplate: (
        req: TransactionTemplateCreateRequest,
    ): ApiResponsePromise<TransactionTemplateInfoResponse> => {
        return axios.post<ApiResponse<TransactionTemplateInfoResponse>>(
            "v1/transaction/templates/add.json",
            req,
        );
    },
    modifyTransactionTemplate: (
        req: TransactionTemplateModifyRequest,
    ): ApiResponsePromise<TransactionTemplateInfoResponse> => {
        return axios.post<ApiResponse<TransactionTemplateInfoResponse>>(
            "v1/transaction/templates/modify.json",
            req,
        );
    },
    hideTransactionTemplate: (
        req: TransactionTemplateHideRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/transaction/templates/hide.json",
            req,
        );
    },
    moveTransactionTemplate: (
        req: TransactionTemplateMoveRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/transaction/templates/move.json",
            req,
        );
    },
    deleteTransactionTemplate: (
        req: TransactionTemplateDeleteRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/transaction/templates/delete.json",
            req,
        );
    },
    getAllInstallmentPlans: (): ApiResponsePromise<
        InstallmentPlanInfoResponse[]
    > => {
        return axios.get<ApiResponse<InstallmentPlanInfoResponse[]>>(
            "v1/installments/list.json",
        );
    },
    getInstallmentPlan: ({
        id,
        ...
        id: string;
    }): ApiResponsePromise<InstallmentPlanInfoResponse> => {
        return axios.get<ApiResponse<InstallmentPlanInfoResponse>>(
            "v1/installments/get.json?id=" + id,
        );
    },
    getInstallmentAccountRules: (): ApiResponsePromise<
        InstallmentAccountRuleInfoResponse[]
    > => {
        return axios.get<ApiResponse<InstallmentAccountRuleInfoResponse[]>>(
            "v1/installments/account_rules/list.json",
        );
    },
    getInstallmentAccountRule: ({
        liabilityAccountId,
    }: {
        liabilityAccountId: string;
    }): ApiResponsePromise<InstallmentAccountRuleInfoResponse> => {
        return axios.get<ApiResponse<InstallmentAccountRuleInfoResponse>>(
            "v1/installments/account_rules/get.json?liabilityAccountId=" +
                liabilityAccountId,
        );
    },
    saveInstallmentAccountRule: (
        req: InstallmentAccountRuleSaveRequest,
    ): ApiResponsePromise<InstallmentAccountRuleInfoResponse> => {
        return axios.post<ApiResponse<InstallmentAccountRuleInfoResponse>>(
            "v1/installments/account_rules/save.json",
            req,
        );
    },
    deleteInstallmentAccountRule: (
        req: InstallmentAccountRuleDeleteRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/installments/account_rules/delete.json",
            req,
        );
    },
    addInstallmentPlan: (
        ...
        return axios.post<ApiResponse<InstallmentPlanInfoResponse>>(
            "v1/installments/add.json",
            req,
        );
    },
    modifyInstallmentPlan: (
        req: InstallmentPlanModifyRequest,
    ): ApiResponsePromise<InstallmentPlanInfoResponse> => {
        return axios.post<ApiResponse<InstallmentPlanInfoResponse>>(
            "v1/installments/modify.json",
            req,
        );
    },
    deleteInstallmentPlan: (
        req: InstallmentPlanDeleteRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/installments/delete.json",
            req,
        );
    },
    payInstallmentItem: (
        req: InstallmentItemPayRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/installments/items/pay.json",
            req,
        );
    },
    unpayInstallmentItem: (
        req: InstallmentItemUnpayRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/installments/items/unpay.json",
            req,
        );
    },
    getAllInsightsExplorers: (): ApiResponsePromise<
        InsightsExplorerInfoResponse[]
    > => {
        return axios.get<ApiResponse<InsightsExplorerInfoResponse[]>>(
            "v1/insights/explorers/list.json",
        );
    },
    getInsightsExplorer: ({
        id,
        ...
        id: string;
    }): ApiResponsePromise<InsightsExplorerInfoResponse> => {
        return axios.get<ApiResponse<InsightsExplorerInfoResponse>>(
            "v1/insights/explorers/get.json?id=" + id,
        );
    },
    addInsightsExplorer: (
        req: InsightsExplorerCreateRequest,
    ): ApiResponsePromise<InsightsExplorerInfoResponse> => {
        return axios.post<ApiResponse<InsightsExplorerInfoResponse>>(
            "v1/insights/explorers/add.json",
            req,
        );
    },
    modifyInsightsExplorer: (
        req: InsightsExplorerModifyRequest,
    ): ApiResponsePromise<InsightsExplorerInfoResponse> => {
        return axios.post<ApiResponse<InsightsExplorerInfoResponse>>(
            "v1/insights/explorers/modify.json",
            req,
        );
    },
    hideInsightsExplorer: (
        req: InsightsExplorerHideRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/insights/explorers/hide.json",
            req,
        );
    },
    moveInsightsExplorer: (
        req: InsightsExplorerMoveRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/insights/explorers/move.json",
            req,
        );
    },
    deleteInsightsExplorer: (
        req: InsightsExplorerDeleteRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/insights/explorers/delete.json",
            req,
        );
    },
    ...
    }): ApiResponsePromise<RecognizedReceiptImageResponse> => {
        return axios.postForm<ApiResponse<RecognizedReceiptImageResponse>>(
    ...
    getLatestExchangeRates: (param: {
        ignoreError?: boolean;
    }): ApiResponsePromise<LatestExchangeRateResponse> => {
        return axios.get<ApiResponse<LatestExchangeRateResponse>>(
            "v1/exchange_rates/latest.json",
            {
                ignoreError: !!param.ignoreError,
                timeout:
                    getExchangeRatesRequestTimeout() || DEFAULT_API_TIMEOUT,
            } as ApiRequestConfig,
        );
    },
    updateUserCustomExchangeRate: (
        req: UserCustomExchangeRateUpdateRequest,
    ): ApiResponsePromise<UserCustomExchangeRateUpdateResponse> => {
        return axios.post<ApiResponse<UserCustomExchangeRateUpdateResponse>>(
            "v1/exchange_rates/user_custom/update.json",
            req,
        );
    },
    deleteUserCustomExchangeRate: (
        req: UserCustomExchangeRateDeleteRequest,
    ): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>(
            "v1/exchange_rates/user_custom/delete.json",
            req,
        );
    },
    ...
    generateMapProxyAnnotationImageUrl: (
        mapProvider: string,
        language: string,
    ): string => {
        const token = getCurrentToken();
    ...
    generateGoogleMapJavascriptUrl: (
    ...
    getInternalAvatarUrlWithToken(
        avatarUrl: string,
        disableBrowserCache?: boolean | string,
    ): string {
        if (!avatarUrl) {
            return avatarUrl;
        }
    ...
    getTransactionPictureUrlWithToken(
        pictureUrl: string,
        disableBrowserCache?: boolean | string,
    ): string {
        if (!pictureUrl) {
